...
typedef enum HazardousLocation_AnimalOnTheRoadSubCauseCode {
	...
	HazardousLocation_AnimalOnTheRoadSubCauseCode_wildAnimalsSmall	= 5,
	HazardousLocation_AnimalOnTheRoadSubCauseCode_wildAnimalsLarge	= 6,
	HazardousLocation_AnimalOnTheRoadSubCauseCode_domesticAnimals	= 7,
	HazardousLocation_AnimalOnTheRoadSubCauseCode_domesticAnimalsSmall	= 8,
	HazardousLocation_AnimalOnTheRoadSubCauseCode_domesticAnimalsLarge	= 9

...
typedef struct SituationContainer {
	...
	struct SituationContainer__ext2 {
		MultiplicativeFactor_t	*eventEndFactor;	/* OPTIONAL */
		PerceivedEvent_t	*perceivedEvent;	/* OPTIONAL */
...
extern asn_TYPE_member_t asn_MBR_SituationContainer_1[6];

...
typedef enum HazardousLocation_SurfaceConditionSubCauseCode {
	...
	HazardousLocation_SurfaceConditionSubCauseCode_earthquakeDamage_deprecated	= 2,
	HazardousLocation_SurfaceConditionSubCauseCode_sinkhole	= 3,
	HazardousLocation_SurfaceConditionSubCauseCode_subsidence	= 4,
	HazardousLocation_SurfaceConditionSubCauseCode_snowDrifts_deprecated	= 5,
	HazardousLocation_SurfaceConditionSubCauseCode_stormDamage_deprecated	= 6,
	HazardousLocation_SurfaceConditionSubCauseCode_burstPipe_deprecated	= 7,
	HazardousLocation_SurfaceConditionSubCauseCode_lava	= 8,
	HazardousLocation_SurfaceConditionSubCauseCode_fallingIce_deprecated	= 9,
	HazardousLocation_SurfaceConditionSubCauseCode_fire	= 10,
	HazardousLocation_SurfaceConditionSubCauseCode_flooding_deprecated	= 11,
	HazardousLocation_SurfaceConditionSubCauseCode_wearAndTear	= 12

...
asn_TYPE_member_t asn_MBR_PerceptionRegion_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PerceptionRegion, perceivedObjectFalseNegativesRate),
		...
		0, 0, /* No default value */
		"perceivedObjectFalseNegativesRate"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct PerceptionRegion, perceptionRegionType),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		+1,	/* EXPLICIT tag at current level */
		&asn_DEF_ReportingType,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
static const int asn_MAP_PerceptionRegion_oms_1[] = { 5, 6, 7 };
...
static const asn_TYPE_tag2member_t asn_MAP_PerceptionRegion_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* perceivedObjectFalseNegativesRate */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* perceptionRegionType */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 }, /* perceptionRegionShape */
    { (ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0, 0 }, /* shadowingApplies */
    { (ASN_TAG_CLASS_CONTEXT | (5 << 2)), 5, 0, 0 }, /* sensorIdList */
    { (ASN_TAG_CLASS_CONTEXT | (6 << 2)), 6, 0, 0 }, /* numberOfPerceivedObjects */
    { (ASN_TAG_CLASS_CONTEXT | (7 << 2)), 7, 0, 0 } /* perceivedObjectIds */
};

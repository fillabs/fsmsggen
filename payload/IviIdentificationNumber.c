...
IviIdentificationNumber_constraint(const asn_TYPE_descriptor_t *td, const void *sptr,
	...
	if(((value >= 1 && value <= 32767) || (value == 8388607))) {
...
asn_per_constraints_t asn_PER_type_IviIdentificationNumber_constr_1 CC_NOTUSED = {
	{ APC_CONSTRAINED | APC_EXTENSIBLE,  23, -1,  1,  8388607 }	/* (1..8388607,...) */,
...
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_IviIdentificationNumber_constr_1,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
		IviIdentificationNumber_constraint
	},
	0, 0,	/* No members */
	0	/* No specifics */
};

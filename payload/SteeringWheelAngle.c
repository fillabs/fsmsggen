...
static const ber_tlv_tag_t asn_DEF_SteeringWheelAngle_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_SteeringWheelAngle_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* steeringWheelAngleValue */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* steeringWheelAngleConfidence */
};
asn_SEQUENCE_specifics_t asn_SPC_SteeringWheelAngle_specs_1 = {
	sizeof(struct SteeringWheelAngle),
	offsetof(struct SteeringWheelAngle, _asn_ctx),
	asn_MAP_SteeringWheelAngle_tag2el_1,
...
asn_TYPE_descriptor_t asn_DEF_SteeringWheelAngle = {
	...
	asn_MBR_SteeringWheelAngle_1,
	2,	/* Elements count */
	&asn_SPC_SteeringWheelAngle_specs_1	/* Additional specs */
};

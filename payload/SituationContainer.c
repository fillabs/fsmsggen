...
static asn_TYPE_member_t asn_MBR_ext2_10[] = {
	{ ATF_POINTER, 2, offsetof(struct SituationContainer__ext2, eventEndFactor),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_MultiplicativeFactor,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
	...
	{ ATF_POINTER, 1, offsetof(struct SituationContainer__ext2, perceivedEvent),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_PerceivedEvent,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
static const asn_TYPE_tag2member_t asn_MAP_ext2_tag2el_10[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* eventEndFactor */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* perceivedEvent */
};
static asn_SEQUENCE_specifics_t asn_SPC_ext2_specs_10 = {
	sizeof(struct SituationContainer__ext2),
	offsetof(struct SituationContainer__ext2, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_SituationContainer_1[] = {
	...
	{ ATF_POINTER, 4, offsetof(struct SituationContainer, linkedCause),
	...
	{ ATF_POINTER, 3, offsetof(struct SituationContainer, eventZone),
	...
	{ ATF_POINTER, 2, offsetof(struct SituationContainer, ext1),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		0,
		&asn_DEF_ext1_7,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct SituationContainer, ext2),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		0,
		&asn_DEF_ext2_10,
		0,
...
static const int asn_MAP_SituationContainer_oms_1[] = { 2, 3, 4, 5 };

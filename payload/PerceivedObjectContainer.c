...
asn_TYPE_member_t asn_MBR_PerceivedObjectContainer_1[] = {
...
static const asn_TYPE_tag2member_t asn_MAP_PerceivedObjectContainer_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* perceivedObjects */
};
asn_SEQUENCE_specifics_t asn_SPC_PerceivedObjectContainer_specs_1 = {
